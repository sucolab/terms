...
4. 前項の規定に関わらず、利用者は、運営会社が技術上又は運営上必要と認める事由がある場合には、該当事由が解消されるまで退会できないものとします。
5. 運営会社は利用者の退会後も、当該利用者の情報を、運営会社が技術上又は運営上必要と認める事由がある場合には必要な期間保持する場合があります。
6. 運営会社は利用者の退会後も、当該利用者の情報を、第12条（プライバシー）第1項に基づいて利用できるものとします。
7. 運営会社は、利用者が規約とポリシーに違反又は違反するおそれがあると認めた場合、あらかじめ利用者に通知することなく、アカウントを停止、削除又は変更等の措置を行うことができるものとし、これらの措置を講じた理由を開示する義務を負うものではありません。
8. 利用者の本サービスにおけるすべての利用権は、理由を問わず、アカウントが削除された時点で消滅します。利用者が誤ってアカウントを削除した場合であっても、アカウントの復旧はできません。
9. 利用者のアカウントは、利用者に一身専属的に帰属します。利用者の本サービスにおけるすべての利用権は、第三者に譲渡、貸与又は相続させることはできません。
10. 本条第 7 項に基づき、運営会社が利用者のアカウントを停止、削除又は変更する等の措置をとった場合に、当該利用者又は第三者に損害が生じても、運営会社に故意又は重過失が認められなかった場合を除き運営会社は一切責任を負わないものとします。

> スコラボアカウントは利用者個人に紐付きます。規約違反があった場合はアカウントの凍結、削除等を行う場合があります。アカウントの削除はお問い合わせの欄をご覧ください。
> アカウントの退会に際して、システム開発上直近の対応が難しい場合(他サービスの利用情報削除によるシステム影響等)や運営が退会を一旦停止させるべきと判断する場合(退会前後の問題行動等)には、原因となる事情が解消されるまで退会を延期させて頂くことがあります。
> また、万が一退会に際し問題があった場合には、問題解決のために必要となる情報を、解決までに必要な一定期間保持させていただくことがあります。そして退会後の個人情報に関しても、プライバシーポリシーに基づき取り扱うものとします。
